Comments:
The run_tests.sh results are in the insight_testsuite folder. 
Codes for features 3 and 4 have slow run times but they are designed to obtain 
the results.  
The pandas package is needed for these codes.
Pylab, os.path, datetime, and timedelta were also imported. 
